...
Config.Boss = {
    phase1Id = 22461,           -- Vindicta alone (Hard Mode)
    phase2Id = 22462,           -- Gorvek and Vindicta (Hard Mode)
    phase3Id = 22463,           -- Gorvek alone (Hard Mode)
    ids = {22461, 22462, 22463}, -- All phases for targeting
    phaseAnimation = 28253,     -- Animation when phasing
...
Config.Prayers = {
    ...
    deflectMelee = {name = "Deflect Melee", varbit = 16775},
}
